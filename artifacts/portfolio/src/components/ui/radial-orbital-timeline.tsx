          ...
          {timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Label */}
                <div className={`absolute top-12 whitespace-nowrap text-xs font-semibold tracking-wider transition-all duration-300 -translate-x-1/2 left-1/2 ${isExpanded ? "text-white scale-125" : "text-white/70"}`}>
                  {item.title}
                </div>
